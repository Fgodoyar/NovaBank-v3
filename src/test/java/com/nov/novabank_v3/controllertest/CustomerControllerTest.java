...
class CustomerControllerTest {
    ...
    void listCustomers_shouldReturn200WithList() throws Exception {
        ...
        mockMvc.perform(get("/api/customers"))
                ...
                .andExpect(jsonPath("$[0].email").value("juan.garcia@email.com"));
    ...
    void findById_shouldReturn200WhenFound() throws Exception {
        ...
        mockMvc.perform(get("/api/customers/1"))
                ...
                .andExpect(jsonPath("$.customer_name").value("Juan García"));
    ...
    void findById_shouldReturn404WhenNotFound() throws Exception {
        when(customerService.findById(99L))
                .thenThrow(new jakarta.persistence.EntityNotFoundException("Cliente no encontrado"));
    ...
    @Test
    @WithMockUser
    @DisplayName("GET /api/customers/email → 400 si falta el query param 'value'")
    void findByEmail_shouldReturn400WhenParamMissing() throws Exception {
